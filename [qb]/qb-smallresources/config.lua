...
Config.Discord = {
    ...
    ["ApplicationId"] = '1142626498096922664', -- The discord application id
    ["IconLarge"] = 'logo_name', -- The name of the large icon
    ["IconLargeHoverText"] = 'Join our server today!', -- The hover text of the large icon
    ["IconSmall"] = 'small_logo_name', -- The name of the small icon
    ["IconSmallHoverText"] = 'Join our Discord! https://discord.gg/T6R4YAfTjS', -- The hover text of the small icon
    ["UpdateRate"] = 120000, -- How often the player count should be updated
    ["ShowPlayerCount"] = true, -- If set to true the player count will be displayed in the rich presence
    ["MaxPlayers"] = 64, -- Maximum amount of players
    ["Buttons"] = {
        {
            text = 'Connect to the Server',
            url = 'fivem://connect/6qr9j6'
        },
        {
            text = 'Join our Discord!',
            url = 'https://discord.gg/T6R4YAfTjS'
        }
    }
}
...
Config.MapText = "Real Roleplay UK" -- This is the name / text shown above the map
...
Config.ConsumablesEat = {
    ...
    ["pizza1"] = math.random(35, 54),
    ["pizza2"] = math.random(35, 54),
    ["pizza3"] = math.random(35, 54),
    ["pizza4"] = math.random(35, 54),
...
Config.ConsumablesAlcohol = {
    ...
    ["orange-vodka"] = math.random(20, 40),
    ["cherry-bomb"] = math.random(20, 40),
    ["minihulk-shot"] = math.random(20, 40),
    ["beach-cocktail"] = math.random(20, 40),
}
