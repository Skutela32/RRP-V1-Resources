...
Config.Weaponone = "weapon_sledghammer"
Config.Weapontwo = "weapon_knife"
Config.ShowItems = true -- shows players they are at a house and what items they need

Config.Rewards = {
    [1] = {
        ["cabin"] = {"plastic", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weapon_golfclub"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"plastic", "rolex", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weed_package"},
        ["livingroom"] = {"plastic", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "weed_package"}
    },
	
	[2] = {
        ["cabin"] = {"advancedlockpick", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "advancedrepairkit"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"advancedlockpick", "rolex", "diamond_ring", "goldchain", "weed_package", "xtcbaggy", "cryptostick", "weapon_knife"},
        ["livingroom"] = {"advancedlockpick", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "weed_package"}
    },
	[3] = {
        ["cabin"] = {"trojan_usb", "diamond_ring", "goldchain", "weed_package", "thermite", "advancedlockpick", "weapon_golfclub"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"trojan_usb", "rolex", "diamond_ring", "goldchain", "weed_purple-haze", "thermite", "cryptostick", "weapon_machete"},
        ["livingroom"] = {"trojan_usb", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "weed_package"}
    },
	[4] = {
        ["cabin"] = {"gatecrack", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weapon_golfclub"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"gatecrack", "rolex", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weapon_wrench"},
        ["livingroom"] = {"gatecrack", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "weed_package"}
    },
	[5] = {
        ["cabin"] = {"electronickit", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weapon_knuckle"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"electronickit", "rolex", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weapon_bat"},
        ["livingroom"] = {"electronickit", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "weed_package"}
    },
	[6] = {
       ["cabin"] = {"drill", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weapon_golfclub"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"drill", "rolex", "diamond_ring", "goldchain", "weed_package", "thermite", "cryptostick", "weed_package"},
        ["livingroom"] = {"drill", "rolex", "houselaptop", "goldchain", "thermite", "cryptostick", "tablet", "weed_package"}
    },
