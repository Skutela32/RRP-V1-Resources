...
Config.WeaponsDamage = {
    ...
    [`WEAPON_KNIFE`] = {model = `WEAPON_KNIFE`, modifier = 0.2, disableCriticalHits = true},
    ...
    [`WEAPON_HAMMER`] = {model = `WEAPON_HAMMER`, modifier = 0.3, disableCriticalHits = true},
    ...
    [`WEAPON_WRENCH`] = {model = `WEAPON_PIPEWRENCH`, modifier = 0.1, disableCriticalHits = true},
    [`weapon_katana`] = {model = `weapon_katana`, modifier = 0.5, disableCriticalHits = true},
    [`weapon_shiv`] = {model = `weapon_shiv`, modifier = 0.3, disableCriticalHits = true},
    [`weapon_sledgehammer`] = {model = `weapon_sledgehammer`, modifier = 0.3, disableCriticalHits = true},
    [`weapon_karambit`] = {model = `weapon_karambit`, modifier = 0.4, disableCriticalHits = true},
