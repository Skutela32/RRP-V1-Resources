...
Config.FrameworkTriggers = { --You can change the esx/qbcore events (IF NEEDED).
    main = 'QBCore:GetObjectt',   --ESX = 'esx:getSharedObject'   QBCORE = 'QBCore:GetObject'
...
Config.DynamicWeather_time = 30 --(in minutes) If dynamic weather is enabled, this value is how long until the weather changes.
Config.RainChance = 70 --The percent chance for it to rain out of 100.
Config.SnowChance = 2 --The percent chance for it to snow out of 100.
Config.ThunderChance = 30 --The percent chance for it to thunder when raining out of 100.
