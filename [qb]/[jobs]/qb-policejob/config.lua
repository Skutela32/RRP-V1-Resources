...
Config.BreakOutCuffing = {active = true, duration = math.random(200,400), pos = math.random(10, 30), width = math.random(10, 20)}
Config.BreakoutMinigame = 'ps-ui' -- Choose the cuff breakout minigame : qb-skillbar / ps-ui (circle)
Config.PSUICOnfig = {numcircle = 1, ms = 5} -- If minigame is ps-ui then choose number of circles and ms 
...
Config.Locations = {
    ...
    ["vehicle"] = {
        [1] = vector4(442.1, -1013.92, 5.63, -184.47), -- LSPD
        [2] = vector4(-458.86, 6031.5, 5.34, -139.15), --BCSO
        [3] = vector4(1858.95, 3681.95, 5.83, -219.83), -- Sandy
    },
    ...
    ["impound"] = {
        [1] = vector3(452.85, -1022.83, 28.46),
    ...
    ["evidence"] = {
        ...
        [2] = vector3(475.07, -996.46, 26.27), -- BCSO
        [3] = vector3(474.61, -994.14, 26.27), -- Sandy
    },
    ["labs"] = {
        [1] = vector3(483.49, -988.62, 31.06), -- LSPD
    },
    ["stations"] = {
        [1] = {label = "Police Station", coords = vector4(428.23, -984.28, 29.76, 3.5), sprite= 137, scale= 0.7, colour= 29},
        [2] = {label = "HMP Blackout", coords = vector4(1845.903, 2585.873, 45.672, 272.249), sprite= 137, scale= 0.7, colour= 29},
        [3] = {label = "MPS Hire Base", coords = vector4(-448.26, 6007.83, 44.01, 225.93), sprite= 137, scale= 0.7, colour= 29},
    },
}
...
Config.CarItems = {
    [1] = {name = "empty_evidence_bag", amount = 10, info = {}, type = "item", slot = 2,},
}
