...
Config.Helicopter = "nhs_nav_2" -- Helicopter model that players with the ambulance job can use
Config.BillCost = 15 -- Price that players are charged for using the hospital check-in system
...
Config.DamageMinorToMajor = 70 -- How much damage would have to be applied for a minor weapon to be considered a major damage event. Put this at 100 if you want to disable it
Config.AlertShowInfo = 2 -- How many injuries a player must have before being alerted about them

Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(302.77, -584.14, 43.27),
	    [2] = vector3(1761.96, 2597.74, 45.66), -- paleto
    },
    ["duty"] = {
    ...
    ["vehicle"] = {
        [1] = vector4(294.578, -574.761, 4.179, 35.79),
        [2] = vector4(-234.28, 6329.16, 3.15, 222.5),
    },
    ["helicopter"] = {
    ...
    ["stash"] = {
        [1] = vector3(307.16, -601.27, 43.27),
    },
    ["beds"] = {
        [1] = {coords = vector4(317.16, -584.03, 43.12, 338.12), taken = false, model = -421052012},
        [2] = {coords = vector4(322.83, -586.27, 43.12, 339.26), taken = false, model = -421052012},
        [3] = {coords = vector4(325.68, -587.53, 43.12, 335.21), taken = false, model = -421052012},
	--- paleto
...
Config.Weapons = { -- Correspond weapon names to their class number
    ...
    [`WEAPON_guitar`] = Config.WeaponClasses['HEAVY_IMPACT'],
