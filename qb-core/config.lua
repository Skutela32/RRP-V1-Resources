...
QBConfig.DefaultSpawn = vector4(-1035.71, -2731.87, 13.86, 0.0)
QBConfig.UpdateInterval = 10 -- how often to update player data in minutes
QBConfig.StatusInterval = 15000 -- how often to check hunger/thirst status in milliseconds
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 5.7 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 5.2 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = "https://discord.gg/T6R4YAfTjS" -- Discord invite link
