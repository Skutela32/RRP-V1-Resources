...
Config.EnableKeybind = true --allow scenes menu to be opened via keybind
Config.KeybindKey = "U" --if EnableKeybind is set to true the key to use, if you change this it will only change for new players
