...
DS_Casino_System_Main_Config = {
    ...
    MapType = 1, --0 = IPL / 1 = UNCLEJUST / 2 = K4MB1 / 3 = GABZ / 4 = CUSTOM MAP (CHECK config_custom_map) / 5 = https://forum.cfx.re/t/the-diamond-casino-enterable-mlo/832067
    ...
    MenuType = "DEFAULT", --DEFAULT = RageUI // MENU = esx_menu_default // OX = ox_lib (check also fxmanifest) // NH = nh-context
