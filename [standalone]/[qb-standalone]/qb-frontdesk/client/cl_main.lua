            ...
            elseif Config.Dispatch == "ps-dispatch" then
                ...
                if data.job == 'police' then
                    if CurrentCops >= Config.Locations[data.job].Required then
                        QBCore.Functions.Notify('You will be assisted shortly!', 'success')
                        if data.type == "assistance" then
                            exports["ps-dispatch"]:CustomAlert({ coords = Config.Locations['police'].Zone.coords, job = { 'police' }, message = "Assitance Required", dispatchCode = "Front Desk", firstStreet = coords, name =  PlayerData.charinfo.firstname:sub(1,1):upper()..PlayerData.charinfo.firstname:sub(2).. " ".. PlayerData.charinfo.lastname:sub(1,1):upper()..PlayerData.charinfo.lastname:sub(2), description = "Assistance Required", radius = 0, sprite = 205, color = 2, scale = 1.0, length = 3, })
                        elseif data.type == "interview" then
                            exports["ps-dispatch"]:CustomAlert({ coords = Config.Locations['police'].Zone.coords, job = { 'police' }, message = "Interview Request", dispatchCode = "Silver Command", firstStreet = coords, name = PlayerData.charinfo.firstname:sub(1,1):upper()..PlayerData.charinfo.firstname:sub(2).. " ".. PlayerData.charinfo.lastname:sub(1,1):upper()..PlayerData.charinfo.lastname:sub(2), description = "Interview Request", radius = 0, sprite = 205, color = 2, scale = 1.0, length = 3, })
                        elseif data.type == "supervisor" then
                            exports["ps-dispatch"]:CustomAlert({ coords = Config.Locations['police'].Zone.coords, job = { 'police' }, message = "Supervisor Request", dispatchCode = "Bronze Command", firstStreet = coords, name = PlayerData.charinfo.firstname:sub(1,1):upper()..PlayerData.charinfo.firstname:sub(2).. " ".. PlayerData.charinfo.lastname:sub(1,1):upper()..PlayerData.charinfo.lastname:sub(2), description = "Supervisor Request", radius = 0, sprite = 205, color = 2, scale = 1.0, length = 3, })
                        end
                        TriggerServerEvent('rs-frontdesk:server:AlertCooldown', data.job, true)
                    else
                        QBCore.Functions.Notify('Not enough officers on duty!', 'error', 3000)
                ...
                elseif data.job == 'ambulance' then
                    if doctorCount >= Config.Locations[data.job].Required then
                        ...
                        elseif data.type == "interview" then
                            exports["ps-dispatch"]:CustomAlert({ coords = Config.Locations['ambulance'].Zone.coords, job = { 'ambulance' }, message = "Interview Request", dispatchCode = "Interview", firstStreet = coords, name = PlayerData.charinfo.firstname:sub(1,1):upper()..PlayerData.charinfo.firstname:sub(2).. " ".. PlayerData.charinfo.lastname:sub(1,1):upper()..PlayerData.charinfo.lastname:sub(2), description = "Interview Request", radius = 0, sprite = 205, color = 2, scale = 1.0, length = 3, })
                        elseif data.type == "supervisor" then
                            exports["ps-dispatch"]:CustomAlert({ coords = Config.Locations['ambulance'].Zone.coords, job = { 'ambulance' }, message = "Supervisor Request", dispatchCode = "NHS Command", firstStreet = coords, name = PlayerData.charinfo.firstname:sub(1,1):upper()..PlayerData.charinfo.firstname:sub(2).. " ".. PlayerData.charinfo.lastname:sub(1,1):upper()..PlayerData.charinfo.lastname:sub(2), description = "Supervisor Request", radius = 0, sprite = 205, color = 2, scale = 1.0, length = 3, })
                        end
                        TriggerServerEvent('rs-frontdesk:server:AlertCooldown', data.job, true)
                    else
                        QBCore.Functions.Notify('Not enough doctors on duty!', 'error', 3000)
