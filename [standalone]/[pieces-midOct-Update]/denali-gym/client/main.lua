...
function Yoga()
    QBCore.Functions.Progressbar('doing_yoga', 'Doing Yoga', 10000, false, false, {
		...
		exports['ps-buffs']:StaminaBuffEffect(10000, 1.2)
		exports['ps-buffs']:AddStressBuff(4000000, 5)
    end, function() -- Cancel
...
function Treadmill()
    QBCore.Functions.Progressbar('doing_running', 'Running on Treadmill', 10000, false, false, {
		...
		exports['ps-buffs']:AddStressBuff(40000000, 5)
    end, function() -- Cancel
        TriggerEvent('inventory:client:busy:status', false)
        QBCore.Functions.Notify("Just Breathe First..", "error") 
    end)
...
function Weights()
    ...
    }, 
    {
		...
		exports['ps-buffs']:AddStressBuff(6000000, 5)
    end, function() -- Cancel
        TriggerEvent('inventory:client:busy:status', false)
        QBCore.Functions.Notify("Just Breathe First..", "error")  
    end)
...
function Core()
    QBCore.Functions.Progressbar('doing_core', 'Doing Chin-ups', 10000, false, false, {
		...
		exports['ps-buffs']:StaminaBuffEffect(600000, 1.2)
    end, function() -- Cancel
        TriggerEvent('inventory:client:busy:status', false)
        QBCore.Functions.Notify("Just Breathe First..", "error")  
    end)
...
function Hang()
    QBCore.Functions.Progressbar('doing_hang', 'Doing Pullups', 10000, false, false, {
		...
		exports['ps-buffs']:StaminaBuffEffect(8000000, 1.2)
    end, function() -- Cancel
        TriggerEvent('inventory:client:busy:status', false)
        QBCore.Functions.Notify("Just Breathe First..", "error")  
    end)
