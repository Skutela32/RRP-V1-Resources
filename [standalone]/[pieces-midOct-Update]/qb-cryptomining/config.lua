...
Config.Crypto = 'renewed-phone' -- 'qb' or 'renewed-phone' depending on the crypto resource you use
Config.RenewedCryptoType = "shung" -- "gne" or "shung" or "xcoin" or "lme" - only change if using renewed phone

Config.Email = false -- if true, it will send the player the emails, if false it wont send the emails
...
Config.Price = {
    ['Stage 1'] = 8500, -- Price to buy the crypto miner
}
