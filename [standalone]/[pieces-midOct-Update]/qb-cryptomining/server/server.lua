...
if getGPU(PlayerCitizenID,'shitgpu')  then
        while true do
            ...
            while MinerStatus do
                ...
                CryptoBalance = CryptoBalance + math.random(1, 1) / 80
                local id = MySQL.update.await('UPDATE cryptominers SET balance = ? WHERE citizenid = ?', {
                ...
                while true do
                    ...
                    while MinerStatus do
                        ...
                        CryptoBalance = CryptoBalance + math.random(1, 2) / 75
                        local id = MySQL.update.await('UPDATE cryptominers SET balance = ? WHERE citizenid = ?', {
                            CryptoBalance, Player.PlayerData.citizenid
                        })
                    ...
                    while true do
                        ...
                        while MinerStatus do
                            ...
                            CryptoBalance = CryptoBalance + math.random(1, 3) / 75
                            local id = MySQL.update.await('UPDATE cryptominers SET balance = ? WHERE citizenid = ?', {
                                CryptoBalance, Player.PlayerData.citizenid
                            })
                            Wait(math.random(1500, 8000))
                        ...
                        while true do
                            ...
                            while true do
                                ...
                                while MinerStatus do
                                    ...
                                    CryptoBalance = CryptoBalance + math.random(1, 4) / 75
                                    local id = MySQL.update.await('UPDATE cryptominers SET balance = ? WHERE citizenid = ?', {
                                        CryptoBalance, Player.PlayerData.citizenid
                                    })
                            ...
                            while true do
                                ...
                                while MinerStatus do
                                    ...
                                    CryptoBalance = CryptoBalance + math.random(1, 5) / 75
                                    local id = MySQL.update.await('UPDATE cryptominers SET balance = ? WHERE citizenid = ?', {
                                        CryptoBalance, Player.PlayerData.citizenid
                                    })
                        ...
                        while true do
                            ...
                            while MinerStatus do
                                ...
                                CryptoBalance = CryptoBalance + math.random(1, 7) / 60
                                local id = MySQL.update.await('UPDATE cryptominers SET balance = ? WHERE citizenid = ?', {
                                    CryptoBalance, Player.PlayerData.citizenid
                                })
