...
---- ** FLEECA HACK CONFIG ** ----
Config.FleecaTime = 30 -- How much time do they have to enter the hack?
...
---- ** PALETO HACK CONFIG ** ----
Config.PaletoTime = 15 -- How much time do they have to enter the hack?
...
---- ** PACIFIC HACK CONFIG ** ----
Config.PacificTime = 30 -- How much time do they have to enter the hack?
...
Config.MarkedBillsWorthMin = 3500 -- Minimum worth of a bag
Config.MarkedBillsWorthMax = 6400 -- Maximum worth of a bag
-- NOTES --
...
---- ** FLEECA ** ----
Config.FleecaBagsMin = 5 -- How many bags of Marked Bills can you MINIMUM get from a FLeeca Table?
Config.FleecaBagsMax = 7 -- How many bags of Marked Bills can you MAXIMUM get from a FLeeca Table?
