...
RP.PropEmotes = {
   ...
   ["drinkprimeorange"] = {
    ...
    ["drinkprimeblueraspberry"] = {
        "mp_player_intdrink",
        "loop_bottle",
        "Drink",
        AnimationOptions =
        {
            Prop = "brum_prime_blueraspberrry",
            PropBone = 18905,
            PropPlacement = {
                0.12,
                0.008,
    ...
    ["drinkprimetropicalpunch"] = {
        "mp_player_intdrink",
        "loop_bottle",
        "Drink",
        AnimationOptions =
        {
            Prop = "brum_prime_tropicalpunch",
            PropBone = 18905,
            PropPlacement = {
                0.12,
                0.008,
