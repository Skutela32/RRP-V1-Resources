...
local MugShotWebhook = 'https://discord.com/api/webhooks/1144397206560972840/vgzW3QeL-cGyzmMDeFUtE7_zvdNbo5cn6TYcT7seGziXCYdPBniUKqsSkE1SOOE6zYNu'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
local ClockinWebhook = 'https://discord.com/api/webhooks/1144461157785161728/K-XBYcGdXdlcLQuJD6a3o2ywNWqDbdweocoEiW003INIzJkk2nZ17NV8_Gst7FRju_2S'
--------------------------------
