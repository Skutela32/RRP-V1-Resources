...
function Framework.Client.VehicleGetFuel(vehicle)
  if (Config.FuelSystem == "cdn-fuel" or Config.FuelSystem == "ps-fuel" or Config.FuelSystem == "lj-fuel" or Config.FuelSystem == "cdn-fuel" or Config.FuelSystem == "hyon_gas_station") then
