...
RegisterNetEvent('fishing:server:catch', function() 
    ...
    if itemFound then
        for i = 1, itemCount, 1 do
			...
			elseif luck >= 990 and luck <= 999 then
			...
			elseif luck >= 980 and luck <= 990 then
			...
			elseif luck >= 955 and luck <= 980 then
			...
			elseif luck >= 930 and luck <= 955 then
			...
			elseif luck >= 880 and luck <= 930 then
			...
			elseif luck >= 780 and luck <= 880 then
			...
			elseif luck >= 750 and luck <= 780 then
			...
			elseif luck >= 600 and luck <= 750 then
				local weight = math.random(1,6)
			...
			elseif luck >= 550 and luck <= 600 then
			...
			elseif luck >= 450 and luck <= 550 then
			...
			elseif luck >= 300 and luck <= 450 then
			...
			elseif luck >= 0 and luck <= 300 then
