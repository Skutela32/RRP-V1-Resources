...
Config.fishingBaitPrice = 2                                     -- Price of fishing bait
Config.BoatAnchorPrice = 150                                    -- Price of a Boat Anchor
Config.FishingBoxPrice = 200                                   -- Price of a Fishing Ice Box

-- Regular Fish
Config.mackerelPrice     = 45                                    -- Price of Mackerel
Config.codfishPrice      = 55                                   -- Price of Cod
Config.bassPrice         = 65                                   -- Price of Normal Fish
Config.flounderPrice     = 75                                   -- Price of Flounder
Config.stingrayPrice     = 100                                   -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = 500                                  -- Price of Dolphins
Config.sharktigerPrice   = 550                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 650                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 1000                                  -- Price of Killer whales

-- Rewards
Config.smallLootboxCash = 100                                  	-- Price of the cash reward for the "Metal Box"
Config.smallLootboxReward = 'meth_bag'                      -- Item reward besides the "Corroded Key"
