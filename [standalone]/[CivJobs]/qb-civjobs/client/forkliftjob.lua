...
local Forklift_Options = {
    ...
    Sprite = {
        icon = 473,
        colour = 12,
        name = 'Mitsubishi Loading Company',
    },
    Forklift = {
    ...
    Payment = {
        flatRate = false,
        flatRateAmount = 10,
        DistanceMultiplier = 0.10, -- Only applies if flatRate = false, pays driver based on multiplying distance from pick up to drop off.
    },
}
