...
Config = {
	...
	CashInLocation = vector4(-1306.93, -822.75, 17.15, 182.13), -- Default Third Window along in Pacific Bank
	...
	Jobs = {
		['beanmachine'] = { MinAmountforTicket = 10, PayPerTicket = 50, Commission = 0.10, },
		['bakery'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['burgershot'] = { MinAmountforTicket = 10, PayPerTicket = 10 , Commission = 0.10, },
		['catcafe'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['gym'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['henhouse'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['pizzathis'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['popsdiner'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['tequilala'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['vanilla'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, },
		['mechanic'] = { MinAmountforTicket = 75, PayPerTicket = 75, Commission = 0.10, },
		['srs'] = { MinAmountforTicket = 75, PayPerTicket = 75, Commission = 0.10, },
		['mechanic2'] = { MinAmountforTicket = 75, PayPerTicket = 75, Commission = 0.10, },
		['tuner'] = { MinAmountforTicket = 75, PayPerTicket = 75, Commission = 0.10, },
		['lostmc'] = { MinAmountforTicket = 10, PayPerTicket = 10, Commission = 0.10, gang = true, }, -- Example of a gang being supported
	},
