...
Config = {
	...
	PayAtDoor = 25, -- Set to nil stop turn this off, set to a number to enable
	...
	RecycleAmounts = {
		...
		["Trade"] = {
			{ amount = 2, itemGive = 1, Min = 1, Max = 3, },
			{ amount = 10, itemGive = 5, Min = 4, Max = 11, },
			{ amount = 100, itemGive = 10, Min = 40, Max = 90, },
			{ amount = 200, itemGive = 10, Min = 80, Max = 125, },
			{ amount = 1000, itemGive = 10, Min = 400, Max = 600, },
		},
	}
}
