...
Config = {
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(14000, 16500),
		["Washing"] = math.random(15000, 18000),
		["Panning"] = math.random(30000, 35000),
		["Pickaxe"] = math.random(15000, 23000),
		["Mining"] = math.random(15000, 20000),
		["Laser"] = math.random(13000, 15000),
	...
	Locations =  {
		...
		["Panning"] = {
			{ name = "Gold Panning", coords = vector3(5027.95, -4443.63, 0.77), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Vineyard
			{ name = "Gold Panning", coords = vector3(5030.08, -4447.45, 0.67), sprite = 467, col = 5, blipTrue = false },

			{ name = "Gold Panning", coords = vector3(5030.43, -4451.56, 0.86), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Tongva

			{ name = "Gold Panning", coords = vector3(5025.61, -4441.98, 0.91), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Tongva
			{ name = "Gold Panning", coords = vector3(5023.39, -4437.76, 0.69), sprite = 467, col = 5, blipTrue = false },
			{ name = "Gold Panning", coords = vector3(5022.99, -4433.96, 0.79), sprite = 467, col = 5, blipTrue = false },

			{ name = "Gold Panning", coords = vector3(5023.96, -4429.64, 0.86), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Wilderness
		},
...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['ruby_ring_silver'] = 130,
		['sapphire_ring_silver'] = 110,

		['diamond_necklace'] = 230,
		['emerald_necklace'] = 210,
		['ruby_necklace'] = 200,
		['sapphire_necklace'] = 180,
		['diamond_necklace_silver'] = 220,
		['emerald_necklace_silver'] = 200,
		['ruby_necklace_silver'] = 190,
		['sapphire_necklace_silver'] = 180,

		['diamond_earring'] = 260,
		['emerald_earring'] = 250,
		['ruby_earring'] = 240,
		['sapphire_earring'] = 230,
		['diamond_earring_silver'] = 220,
		['emerald_earring_silver'] = 210,
		['ruby_earring_silver'] = 200,
		['sapphire_earring_silver'] = 190,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 1, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "sandwich", price = 2, amount = 250, info = {}, type = "item", slot = 2, },
			{ name = "bandage", price = 5, amount = 100, info = {}, type = "item", slot = 3, },
			{ name = "weapon_flashlight", price = 10, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 150, amount = 100, info = {}, type = "item", slot = 5, },
			{ name = "pickaxe",	price = 200, amount = 100, info = {}, type = "item", slot = 6, },
			{ name = "miningdrill",	price = 2000, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "mininglaser",	price = 50000, amount = 5, info = {}, type = "item", slot = 8, },
