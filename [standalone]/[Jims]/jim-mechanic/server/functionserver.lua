...
---==[[ SLASH COMMANDS ]]==---
	...
	QBCore.Commands.Add("extraseat", Loc[Config.Lan]["servfunction"].seat, {{name="id", help="Seat ID"}}, false, function(source, args) TriggerClientEvent("jim-mechanic:seat", source, args[1]) end)
