Config = {
	...
	Main = { -- Main variables
		...
		JobRoles = { "srs", "redline", "mechanic2", "midnightsyn", "mechanic"}, -- These are the job roles who can use items if RequiresJob is enabled.
	...
	Overrides = {
		...
		modCam = true,				-- true to stop allow custom cameras when editing vehicles
	},
	Harness = {
	...
	CarLifts = {
		...
		Sound = false,					-- Enable/Disable carlift movement noises
	...
	Repairs = {	--Repair Related
		...
		Parts = {  --- Part repair item and its MAX cost
			["engine"] = { part = "iron", cost = 4 },
			["body"] = { part = "plastic", cost = 4 },
			["oil"] = { part = "newoil", cost = 1 },
			["axle"] = { part = "axleparts", cost = 1 },
			["spark"] = { part = "sparkplugs", cost = 1 },
			["battery"] = { part = "carbattery", cost = 1 },
			["fuel"] = { part = "steel", cost = 4 },
			["wheels"] = { part = nil }, -- Has no cost, 1 per damaged wheel
		},
	},
	Previews = {
	...
	NOS = { -- NOS STUF
		...
		NosRefillCharge = 500, 	-- amount in dollars required to refill a nos can
		...
		NitrousUseRate = 0.6, 		-- How fast the nitrous drains (halved for level1, doubled for level3)
