...
Config.CostMultiplier = 0.01 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
Config.GlobalTax = 0.01 -- The tax, in %, that people will be charged at the pump. (Default: 15% or 15.0)
...
Config.MaxFuelPrice = 2 -- This is the maximum value you want to let players set their fuel prices to.
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [27] = {
        ...
        electriccharger = nil,
        electricchargercoords = vector4(163.91, -3009.98, 0.92, 331.19),
        label = "Syndicate Fuel",
    },
    [28] = {
        zones = {
            vector2(157.55, -3014.3),
            vector2(157.14, -3000.78),
            vector2(169.78, -2999.45),
            vector2(171.77, -3017.82)
        },
        minz = 4.5,
        maxz = 7.9,
        pedmodel = "a_m_m_indian_01",
        ...
        electriccharger = nil,
        electricchargercoords = vector4(-341.63, -1459.39, 2.76, 271.73),
