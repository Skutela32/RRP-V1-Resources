...
Config.carbuilderjob = 'midnightsyn'
Config.job_AllShopFree = false
-- CONFIGURE THIS PART (MAIN SETTINGS)
...
Config.JunkShop = {
	['Junk Shop'] = { -- <-- dont change -- this is where your players can buy vehicle shells aka junk vehicle for project cars
		server = false,
		label = 'Syndicate Tuners Shells', -- can change
		model = GetHashKey('mp_m_waremech_01'),
		event = 'renzu_projectcars:openshop',
		coord = vector3(153.43, -3008.18, 7.04),
		blipsprite = 524,
...
Config.parts = { -- parts initial shop price, props, labels
	['door'] = {prop = 'prop_car_door_01', price = 50, label = 'Door', metaprice = 0.01},
	['bonnet'] = {prop = 'imp_prop_impexp_bonnet_02a', price = 50, label = 'Hood' , metaprice = 0.01},
	['trunk'] = {prop = 'imp_prop_impexp_trunk_01a', price = 50, label = 'Trunk' , metaprice = 0.01},
	['wheel'] = {prop = 'prop_wheel_01', price = 30, label = 'Wheel' , metaprice = 0.01},
	['seat'] = {prop = 'prop_car_seat', price = 50, label = 'Seat', metaprice = 0.01},
	['engine'] = {prop = 'prop_car_engine_01', price = 500, label = 'Engine', metaprice = 0.01},
	['transmition'] = {prop = 'imp_prop_impexp_gearbox_01', price = 300, label = 'Transmission', metaprice = 0.01},
	['exhaust'] = {prop = 'imp_prop_impexp_exhaust_01', price = 300, label = 'Exhaust', metaprice = 0.01},
	['brake'] = {prop = 'imp_prop_impexp_brake_caliper_01a', price = 20, label = 'Brake', metaprice = 0.01},
	['paint'] = {prop = 'ng_proc_spraycan01b', price = 15000, label = 'Paint', func = 'renzu_projectcars:openpaint', metaprice = 0.001},
}
...
Config.Paint = { -- paint initial price, Label, itemname, and rgb colors (this feature required your garage to support CustomColour)
    ...
    ['white'] = {label = 'Paint White', item = 'paint_white', price = 15, color = {255, 255, 255}},
    ['red'] =  {label = 'Paint Red', item = 'paint_red',price = 15, color = {255, 0, 0}},
    ['pink'] = {label = 'Paint Pink', item = 'paint_pink',price = 15, color = {253, 51, 153}},
    ['blue'] = {label = 'Paint Blue', item = 'paint_blue',price = 15, color = {0, 0, 255}},
    ['yellow'] = {label = 'Paint Yellow', item = 'paint_yellow',price = 15, color = {255, 255, 0}},
    ['green'] = {label = 'Paint Green',item = 'paint_green',price = 15, color = {0, 255, 0}},
    ['orange'] = {label = 'Paint Orange', item = 'paint_orange',price = 15, color = {153, 76, 0}},
    ['brown'] = {label = 'Paint Brown', item = 'paint_brown',price = 15, color = {51, 25, 0}},
    ['purple'] =  {label = 'Paint Purple',item = 'paint_purple',price = 15, color = {128, 1, 128}},
    ['grey'] = {label = 'Paint Grey', item = 'paint_grey',price = 15, color = {50, 50, 50}},
    ['black'] = {label = 'Paint Black', item = 'paint_black',price = 15, color = {0, 0, 0}},
}
...
Config.Garage = {
	[1] = {
		buy = {model = 'u_m_m_streetart_01', label = 'Rent Garage (1 day : $'..Config.EntraceFee..')', coord = vector3(108.83, -1088.46, 29.3), cost = 10000},
