...
Config.UseRenewedPhoneGroups = true -- toggle if you want to allow groups through Renewed Phone
Config.MaxGroupSize = 5 -- only used if UseRenewedPhoneGroups is true
Config.SpawnDistance = 500 -- How close a player in the group can be before the enemies spawn
...
Config.Cooldown = 3600 --- Cooldown until next allowed run (in seconds)
...
local lowLoc = {
    burroHeights = {
        ...
        Guards = {
            { model = 'a_m_m_soucent_01', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_m_armlieut_01', weapon = 'weapon_hammer' },
            { model = 'g_m_importexport_01', weapon = 'weapon_hammer' },
            { model = 'g_m_importexport_01', weapon = 'weapon_hammer' },
        },
        GuardPositions = {
    ...
    windFarm = {
        ...
        Guards = {
            { model = 'g_m_y_lost_01', weapon = 'WEAPON_PISTOL50', },
            { model = 'g_m_y_lost_02', weapon = 'weapon_hammer' },
            { model = 'g_m_y_lost_03', weapon = 'weapon_hammer' },
        },
        GuardPositions = {
...
local midLoc = {
    docks = {
        ...
        Guards = {
            { model = 'g_m_m_armgoon_01', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_m_armgoon_01', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_m_armlieut_01', weapon = 'weapon_hammer' },
            { model = 'g_m_m_armboss_01', weapon = 'weapon_hammer' },
        },
        GuardPositions = {
    ...
    ogmeth = {
        ...
        Guards = {
            { model = 'g_m_y_lost_01', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_y_lost_02', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_y_lost_03', weapon = 'weapon_hammer' },
            { model = 'g_m_y_lost_02', weapon = 'weapon_hammer' },
            { model = 'g_m_y_lost_03', weapon = 'weapon_hammer' },
        },
...
local highLoc = {
    lafuenta = {
         ...
         Guards = {
             ...
             { model = 'g_m_y_mexgang_01', weapon = 'WEAPON_PISTOL50' },
             { model = 'g_m_y_mexgang_01', weapon = 'WEAPON_PISTOL50' },
             { model = 'g_m_y_mexgang_01', weapon = 'WEAPON_PISTOL50' },
             { model = 'g_m_y_mexgang_01', weapon = 'WEAPON_PISTOL50' },
             { model = 'g_m_y_mexgang_01', weapon = 'WEAPON_PISTOL50' },
    ...
    lakevinewood = {
        ...
        Guards = {
            { model = 'g_m_m_mexboss_02', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_m_mexboss_02', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_y_armgoon_02', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_y_armgoon_02', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_y_armgoon_02', weapon = 'WEAPON_PISTOL50' },
            { model = 'g_m_y_armgoon_02', weapon = 'weapon_machinepistol', accuracy = 50 },
        },
        GuardPositions = {
    ...
    butcher = { -- MADE BY x58k#7833
        ...
        Guards = {
            { model = 's_m_m_linecook', weapon = 'WEAPON_PISTOL50' },
            { model = 's_f_y_factory_01', weapon = 'WEAPON_PISTOL50' },
            { model = 's_m_y_factory_01', weapon = 'WEAPON_PISTOL50' },
            { model = 's_f_y_factory_01', weapon = 'WEAPON_PISTOL50' },
            { model = 's_m_y_factory_01', weapon = 'weapon_heavypistol' },
        },
        GuardPositions = {
			...
			vector4(-74.92, 6222.74, 31.09, 17.2),
			vector4(-73.7, 6239.55, 31.08, 296.95),
			vector4(-97.18, 6205.9, 31.03, 38.06),
            vector4(-133.22, 6162.08, 31.02, 131.32),
			vector4(-110.67, 6196.57, 31.03, 315.46),
...
local lowJob = {
    ...
    payout = math.random(3000,7000), -- how much money you get
    ...
    Boss = {
        coords = vector4(2330.02, 2569.99, 46.68, 325.13),
    ...
    Rewards = {
        { item = 'meth_bag', amount = math.random(20, 50), chance = 100 },
        { item = 'coke_figure', amount = 50, chance = 100 }
    }
}

local midJob = {
    paymentType = 'cash', -- what type of payment to enter, can be cash, band or crypto
    runCost = 7000, -- cost to take run
    payoutType = 'cash', -- type of payment, can be cash, bank or crypto
    payout = math.random(5000,8000), -- how much money you get
    ...
    Boss = {
        coords = vector4(-621.83, 312.27, 83.93, 177.42),
        model = 'g_f_importexport_01',
        missionTitle = "Accept weed raid",
        animation = 'WORLD_HUMAN_HANG_OUT_STREET', -- OPTIONAL https://pastebin.com/6mrYTdQv
    },
    Rewards = {
        { item = 'meth_bag', amount = math.random(30, 60), chance = 100 },
        { item = 'coke_figure', amount = 75, chance = 100 }
    }
}
local highJob = {
    paymentType = 'cash', -- what type of payment to enter, can be cash, band or crypto
    runCost = 9000, -- cost to take run
    payoutType = 'cash', -- type of payment, can be cash, bank or crypto
    payout = math.random(8000,10000), -- how much money you get
    ...
    Boss = {
        coords = vector4(-427.96, 1114.48, 326.77, 343.68),
        model = 'g_f_importexport_01',
        missionTitle = "Accept weed raid",
        animation = 'WORLD_HUMAN_HANG_OUT_STREET', -- OPTIONAL https://pastebin.com/6mrYTdQv
    },
    Rewards = {
        { item = 'meth_bag', amount = math.random(10, 30), chance = 70 },
        { item = 'coke_figure', amount = 100, chance = 30 }
    }
}
