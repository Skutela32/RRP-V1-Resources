...
Config.Madrazo = {
    ...
    Location = {
        Coords = vec3(-30.66, -346.94, -46.53),
        Heading = 270.7,
        radius = 0.7,
    },
...
Config.Gerald = {
    ...
    Location = {
        Coords = vec3(-326.44, -1300.18, -31.36),
        Heading = 272.42,
        radius = 0.7,
    },
...
Config.Pharmacist = {
    ...
    Items = {
        { label = 'Empty Plastic Can', item = 'meth_emptysacid', description = "Buy Empty Plastic Can for: £",
            price = 15, MinAmount = 1, MaxAmount = 1 },
        { label = 'Amonian', item = 'meth_amoniak', description = "Buy Amonian for: £", price = 3, MinAmount = 1,
            MaxAmount = 5 },
        { label = 'Syringe', item = 'syringe', description = "Buy Syringe for: £", price = 20, MinAmount = 1,
            MaxAmount = 1 },
        { label = 'Meth Pipe', item = 'meth_pipe', description = "Buy Meth Pipe for: £", price = 20, MinAmount = 1,
            MaxAmount = 1 },
        { label = 'Crack Pipe', item = 'crack_pipe', description = "Buy Crack Pipe for: £", price = 20, MinAmount = 1,
            MaxAmount = 1 },
    },
...
Config.Dealer = {
    Header = "Weed Dealer",
    Items = {
        { label = 'Weed Access Card', item = 'weed_access', description = "Buy Weed Access for: £", price = 500,
            MinAmount = 1, MaxAmount = 1 },
        { label = 'Weed Papers', item = 'weed_papers', description = "Buy Weed Papers for: £", price = 1, MinAmount = 1,
            MaxAmount = 5 },
        { label = 'Blunt Wraps', item = 'weed_wrap', description = "Buy Blunt wraps for: £", price = 2, MinAmount = 1,
            MaxAmount = 5 },
        { label = 'Plastic Bag', item = 'plastic_bag', description = "Buy Plastic Bag for: £", price = 1, MinAmount = 1,
            MaxAmount = 10 },
    },
    Ped = {
        { model = "s_m_y_dealer_01", coords = vec4(185.26, -581.88, 42.87, 208.6), scenario = "WORLD_HUMAN_SMOKING" },
    },
}
...
Config.MedicamentsShop = {
    ...
    Items = {
        ...
        { label = 'Xanax', item = 'xanaxpack', description = "Buy Xanax for: £", price = 20, MinAmount = 1,
            MaxAmount = 2 },
        { label = 'Ecstasy', item = 'ecstasy', description = "Buy Ecstasy for: £", price = 20, MinAmount = 1,
            MaxAmount = 2 },
    },
    Ped = {
...
Config.ComicShop = {
    Header = "Comic Shop",
    Items = {
        { label = 'Action Figure', item = 'coke_figureempty', description = "Buy Action Figure for: £", price = 10,
            MinAmount = 1, MaxAmount = 15 },
    },
    Ped = {
...
Config.FlowerShop = {
    Header = "Flower Shop",
    Items = {
        { label = 'Hammer', item = 'hammer', description = "Buy Hammer for: £", price = 10, MinAmount = 1, MaxAmount = 2 },
        { label = 'Trowel', item = 'trowel', description = "Buy Trowel for: £", price = 5, MinAmount = 1, MaxAmount = 2 },
        { label = 'Scissors', item = 'scissors', description = "Buy Scissors for: £", price = 25, MinAmount = 1,
            MaxAmount = 2 },
        { label = 'Glue', item = 'glue', description = "Buy Glue for: £", price = 1, MinAmount = 1, MaxAmount = 2 },
        { label = 'Baking Soda', item = 'baking_soda', description = "Buy Baking Soda for: £", price = 10, MinAmount = 1,
            MaxAmount = 2 },
    },
    Ped = {
...
Config.Weed = {
    ...
    --ENTER LAB
    Enterlab = {
        coords = vector3(2856.57, 4458.33, 48.5),
        radius = 1.2,
    ...
    Pickup = {
        ...
        RequiredItems = {
            { item = "trimming_scissors", count = 1, remove = false },
        },
        AddItems = {
            { item = "weed_bud", count = 3 },
        },
...
Config.Meth = {
    ...
    Complete = {
        ...
        AddItems = {
            { item = "meth_glass", count = 3 },
            { item = "meth_emptysacid", count = 3 },
        },
...
Config.Heroin = {
    --Field
    Field = {
        coords = vec3(-182.02, 3117.05, 34.53),
        radius = 30.85,
        Duration = 10000,
        name = "PoppyField",
        debugPoly = false,
    ...
    Process = {
        ...
        Duration = 30000,
        RequiredItems = {
            { item = "poppyplant", count = 2, remove = true },
            { item = "meth_amoniak", count = 1, remove = true },
            { item = "plastic_bag", count = 1, remove = true },
        },
        AddItems = {
...
Config.Coke = {
    ...
    --Field
    Field = {
        coords = vector3(1847.25, 4918.88, 45.09),
        radius = 65.0,
        DebugPoly = false,
        name = "Cokefield",
        RequiredItems = {
    ...
    LeafProcess = {
        ...
        RequiredItems = {
            { item = "coke_leaf", count = 3, remove = true },
        },
        AddItems = {
            { item = "coke_box", count = 2 },
        },
        Log = "Has proccessed 3x Coke Leaves into 2X Coke Box"
    },
    --CokeBox
    CokeBox = {
        header = "Pour Coke",
    ...
    Soda = {
        ...
        AddItems = {
            { item = "coke_pure", count = 3 },
        },
        Log = "Has proccessed 2x Raw Coke into 2x Pure Coke"
    },
    SodaTables = {
    ...
    FigurePackage = {
        ...
        RequiredItems = {
            { item = "coke_pure", count = 3, remove = true },
...
Config.PeyoteField = {
    --Field!
    coords = vec3(1026.42, 4329.12, 41.31),
    radius = 38.85,
    name = "PeyoteField",
    debugPoly = false,
    RequiredItems = {
...
Config.Drugs = {
    weed_package = { -- Item name
        ...
        MinPrice = 60, -- Min price
        MaxPrice = 120, -- Max price
    ...
    meth_bag = { -- Item name
        ...
        MinPrice = 170, -- Min price
        MaxPrice = 210, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 5, -- Max Count
        Chance = 90, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
        animation = {
    ...
    coke_figure = { -- Item name
        ...
        ReqPolice = 1, -- Police count
        ReportChance = 25, --Dispatch Chance 0 - 100 %
        MinPrice = 210, -- Min price
        MaxPrice = 260, -- Max price
        MinCount = 1, -- Min Count
        MaxCount = 5, -- Max Count
        Chance = 90, -- 0 - 100% succes of negotiate for better price
        AttackChance = 5, -- 0 - 100% Chance of NPC atacking player
